      ...
      <div className="max-w-2xl mx-auto px-6">
        <div className="space-y-8">
          <div>
            ...
            <p className="text-xl md:text-2xl text-gray-600 mt-4 font-mono">
          ...
          <div className="pt-4">
            <div className="inline-flex items-center flex-wrap bg-gray-50 rounded-lg px-4 py-2 border border-gray-200">
