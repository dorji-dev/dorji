...
export default async function ReposComponent() {
  ...
  return (
    <section id="repos" className="py-20 bg-background">
      <div className="max-w-[700px] mx-auto px-6">
        <h2 className="text-2xl font-bold mb-12 text-foreground font-mono animate-slide-up">
          github repositories
        </h2>
        {repos.length === 0 ? (
          <div className="mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-800 dark:bg-yellow-950/20 dark:border-yellow-800/30 dark:text-yellow-200">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {displayRepos.map((repo) => (
              <a
                ...
                className="block p-8 border border-border/60 bg-card hover:bg-muted/50 hover:border-border transition-all duration-300 group h-full rounded-xl hover:scale-[1.02] animate-slide-up"
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex justify-between mb-4">
                    ...
                    <div className="flex items-center h-fit space-x-1.5 text-muted-foreground group-hover:text-yellow-500 transition-colors duration-200">
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    <div className="flex items-center text-muted-foreground group-hover:text-foreground transition-colors duration-200">
                      <svg
                    ...
                    {repo.language && (
                      <span className="text-xs px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full font-medium border border-blue-200/50 dark:bg-blue-950/30 dark:text-blue-300 dark:border-blue-800/30">
                        {repo.language}
                      </span>
                    )}
                  </div>
